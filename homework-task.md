...
18. Если полей пользователя нет в конфигурации, добавить их(git config user.email "ваш email, такой же как на github" и git config user.name "ваше имя")
...
29. Разберитесь что git вам говорит(он подскажет что делать), в итоге вы должны залить ветку в новый удаленный репозиторий
```
